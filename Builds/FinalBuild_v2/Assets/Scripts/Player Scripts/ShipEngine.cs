...
public class ShipEngine : MonoBehaviour 
{
	...
	bool isInvincible, waitingToSpawn;
	float spawnTime, currentSpawnTimer;
	...
	public void explode()
	{
		GameObject explosion = (GameObject)Instantiate(GameManager.instance.playerExplosion, 
		                                               tf.position, Quaternion.identity);
		explosion.GetComponent<Animator>().speed = 0.25f;
